...
const navSections: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Teachers", href: "/dashboard/teachers", icon: School },
      { label: "Admissions", href: "/dashboard/admissions", icon: UserPlus, badge: "New" },
    ],
  },
  {
    title: "Academics",
    items: [
      ...
      { label: "Lesson Plans", href: "/dashboard/lesson-plans", icon: BookOpen },
    ],
  },
  {
    title: "Finance",
