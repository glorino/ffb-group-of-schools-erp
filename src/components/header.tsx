              ...
              <AnimatePresence>
                {notificationsOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-10 w-[320px] rounded-xl bg-[var(--sidebar)]/95 backdrop-blur-3xl border border-white/[0.08] shadow-2xl shadow-black/40 overflow-hidden z-[60]"
                  >
