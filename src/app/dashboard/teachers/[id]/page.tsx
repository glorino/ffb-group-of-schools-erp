  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="card bg-gradient-to-r from-[#0a2a6e] to-[#0055ff] border-white/10 mx-10 mt-8 p-8 shadow-sm"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${teacher.status === "active" ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-red-50 text-red-700 border border-red-200"}`}>
                {teacher.status}
              </span>
            </div>
          ...
          <div className="flex gap-2 shrink-0">
            {editing ? (
              <>
                <button onClick={handleSave} className="flex items-center gap-2 btn btn-primary">
                  <Save className="w-4 h-4" /> Save
                </button>
                <button onClick={() => setEditing(false)} className="flex items-center gap-2 btn btn-secondary">
                  <X className="w-4 h-4" /> Cancel
                </button>
              </>
            ) : (
              <button onClick={startEdit} className="flex items-center gap-2 btn btn-secondary">
        ...
        {tabs.map((t) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              tab === t.id ? "bg-[var(--primary)] text-white shadow-sm" : "text-[#64748b] hover:text-white"
            }`}
          >
                ...
                {[
                  ...
                  <div key={f.key}>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-xl bg-[#ffffff] border border-[#e2e8f0] text-white text-[13px] focus:outline-none focus:border-[var(--primary)]"
                    />
                  </div>
                ))}
              </div>
