...
export default function AdmissionsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#0a2a6e] to-[#0055ff] rounded-2xl p-8 border border-white/10 mt-8" style={{ background: "linear-gradient(to right, #0a2a6e, #0055ff)" }}>
