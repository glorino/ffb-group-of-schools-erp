...
export default function NotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-6 mt-6 bg-gradient-to-r from-[#0a2a6e] to-[#0055ff] rounded-2xl p-7 border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
