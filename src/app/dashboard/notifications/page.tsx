...
export default function NotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-8 mt-8 bg-gradient-to-r from-[#0a2a6e] to-[#0055ff] rounded-2xl p-8 border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4" style={{ background: "linear-gradient(to right, #0a2a6e, #0055ff)" }}>
        <div>
