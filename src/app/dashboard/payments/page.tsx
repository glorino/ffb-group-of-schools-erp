  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="card bg-gradient-to-r from-[#0a2a6e] to-[#0055ff] border-white/10 mx-10 mt-8 p-8"
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2 items-center">
            ...
            >
              ...
              <option value="completed" style={{ background: "#ffffff", color: "#1a1a2e" }}>Completed</option>
              <option value="pending" style={{ background: "#ffffff", color: "#1a1a2e" }}>Pending</option>
              <option value="failed" style={{ background: "#ffffff", color: "#1a1a2e" }}>Failed</option>
            </select>
            <select
              value={filterMethod}
              ...
              className="px-3 py-2 rounded-xl bg-[#ffffff] border border-[#e2e8f0] text-[#1a1a2e] text-[13px] focus:outline-none focus:border-[var(--primary)]"
            >
              <option value="" style={{ background: "#ffffff", color: "#1a1a2e" }}>All Methods</option>
              <option value="cash" style={{ background: "#ffffff", color: "#1a1a2e" }}>Cash</option>
              <option value="bank_transfer" style={{ background: "#ffffff", color: "#1a1a2e" }}>Bank Transfer</option>
              <option value="card" style={{ background: "#ffffff", color: "#1a1a2e" }}>Card</option>
              <option value="online" style={{ background: "#ffffff", color: "#1a1a2e" }}>Online</option>
            </select>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <th className="text-left text-[#64748b] text-[11px] font-semibold uppercase tracking-wider pb-3 px-4">Student</th>
              <th className="text-left text-[#64748b] text-[11px] font-semibold uppercase tracking-wider pb-3 px-4">Amount</th>
              <th className="text-left text-[#64748b] text-[11px] font-semibold uppercase tracking-wider pb-3 px-4">Method</th>
              <th className="text-left text-[#64748b] text-[11px] font-semibold uppercase tracking-wider pb-3 px-4">Invoice</th>
