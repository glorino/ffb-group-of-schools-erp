const routeRoles: Record<string, string[]> = {
  ...
  "/dashboard/news": ["OWNER", "ADMINISTRATOR", "PRINCIPAL", "VICE_PRINCIPAL"],
  "/dashboard/events": ["OWNER", "ADMINISTRATOR", "PRINCIPAL", "VICE_PRINCIPAL", "TEACHER", "STUDENT", "PARENT"],
  ...
  "/dashboard/activity-log": ["OWNER", "ADMINISTRATOR", "PRINCIPAL", "AUDITOR"],
  "/dashboard/change-password": ["OWNER", "ADMINISTRATOR", "PRINCIPAL", "VICE_PRINCIPAL", "TEACHER", "STUDENT", "PARENT", "ACCOUNTANT", "AUDITOR", "LIBRARIAN", "PORTER", "ALUMNI"],
  "/dashboard/profile": [],
